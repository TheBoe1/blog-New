...
>
> **Every visual decision should answer one question: does it improve readability, hierarchy, or interaction? If it improves none of them, it probably doesn't belong.** 每个视觉决策必须明确提升阅读、层级、交互中的至少一项——否则不该进入系统。
